    ...
    return (
        <div className="orderSyncPro" >
            ...
            <ul>
                ...
                <li>Configure la información básica del restaurante, como el nombre, la dirección y el número de mesas.</li>
            </ul>
            <h2>2. Creación y edición de menús diarios:</h2>
            <ul>
                <li>Acceda a la sección Menús y seleccione Nuevo Menú para crear un menú diario.</li>
                <li>Añada platos, precios y descripciones, y organice los elementos en categorías, como entradas, platos principales y postres.</li>
                <li>Guarde el menú y configúrelo como  Activo  para que esté disponible para los meseros.</li>
            </ul>
            <h2>3. Tomar un pedido:</h2>
            <ul>
                <li>Desde la pantalla principal, seleccione la mesa a la que desea asignar un pedido.</li>
                <li>Añada los elementos del menú al pedido, ajustando las cantidades y agregando notas especiales si es necesario.</li>
                <li>Cuando haya terminado de agregar elementos al pedido, haga clic en  Guardar  para enviar el pedido a la cocina.</li>
            </ul>
            <h2>4. Visualización y gestión de pedidos:</h2>
            <ul>
                <li>Acceda a la sección  Pedidos  para ver todos los pedidos activos, organizados por mesa.</li>
                <li>Haga clic en un pedido para ver los detalles, como los elementos del pedido, las notas especiales y el tiempo de envío.</li>
                <li>Actualice el estado del pedido (por ejemplo, en preparación, listo para servir, servido) según sea necesario.</li>
            </ul>
            <h2>5. Estadísticas y análisis de ventas:</h2>
            <ul>
                <li>Acceda a la sección  Estadísticas  para ver información sobre las ventas y el rendimiento del restaurante.</li>
                <li>Utilice los filtros de fecha y hora para analizar datos específicos, como las ventas diarias, semanales o mensuales.</li>
                <li>Visualice gráficos y tablas que muestren tendencias de ventas y elementos populares del menú.</li>
            </ul>
            <h2>6. Cierre de sesión y fin del turno:</h2>
            <ul>
